...
The following options can be passed to any command:
    ...
    --noobaa-image='noobaa/noobaa-core:6.0.0': NooBaa image
    --operator-image='noobaa/noobaa-operator:6.0.0': Operator image
...
```
INFO[0000] CLI version: 6.0.0
INFO[0000] noobaa-image: noobaa/noobaa-core:6.0.0
INFO[0000] operator-image: noobaa/noobaa-operator:6.0.0
```
