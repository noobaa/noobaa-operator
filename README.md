...
The following options can be passed to any command:
    ...
    --noobaa-image='noobaa/noobaa-core:5.17.10': NooBaa image
    --operator-image='noobaa/noobaa-operator:5.17.10': Operator image
...
```
INFO[0000] CLI version: 5.17.10
INFO[0000] noobaa-image: noobaa/noobaa-core:5.17.10
INFO[0000] operator-image: noobaa/noobaa-operator:5.17.10
```
