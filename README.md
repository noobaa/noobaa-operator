...
# or
wget https://github.com/noobaa/noobaa-operator/releases/download/v2.0.0/noobaa-mac-v2.0.0; mv noobaa-mac-* noobaa; chmod +x noobaa
```

For Linux
```
wget https://github.com/noobaa/noobaa-operator/releases/download/v2.0.0/noobaa-linux-v2.0.0; mv noobaa-linux-* noobaa; chmod +x noobaa
```
