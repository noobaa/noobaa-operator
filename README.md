...
The following options can be passed to any command:
    ...
    --noobaa-image='noobaa/noobaa-core:5.18.6': NooBaa image
    --operator-image='noobaa/noobaa-operator:5.18.6': Operator image
...
INFO[0000] noobaa-image: noobaa/noobaa-core:5.18.6
