...
# or
wget https://github.com/noobaa/noobaa-operator/releases/download/v2.0.5/noobaa-mac-v2.0.5; mv noobaa-mac-* noobaa; chmod +x noobaa
```

For Linux
```
wget https://github.com/noobaa/noobaa-operator/releases/download/v2.0.5/noobaa-linux-v2.0.5; mv noobaa-linux-* noobaa; chmod +x noobaa
```
