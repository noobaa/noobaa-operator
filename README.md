...
The following options can be passed to any command:
    ...
    --noobaa-image='noobaa/noobaa-core:5.16.7': NooBaa image
    --operator-image='noobaa/noobaa-operator:5.16.7': Operator image
...
```
INFO[0000] CLI version: 5.16.7
INFO[0000] noobaa-image: noobaa/noobaa-core:5.16.7
INFO[0000] operator-image: noobaa/noobaa-operator:5.16.7
```
