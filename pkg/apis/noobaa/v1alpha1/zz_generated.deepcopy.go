...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlertThresholdsSpec) DeepCopyInto(out *AlertThresholdsSpec) {
	*out = *in
	if in.BucketLowCapacityPercent != nil {
		in, out := &in.BucketLowCapacityPercent, &out.BucketLowCapacityPercent
		*out = new(int32)
		**out = **in
	}
	if in.BucketNoCapacityPercent != nil {
		in, out := &in.BucketNoCapacityPercent, &out.BucketNoCapacityPercent
		*out = new(int32)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlertThresholdsSpec.
func (in *AlertThresholdsSpec) DeepCopy() *AlertThresholdsSpec {
	if in == nil {
		return nil
	}
	out := new(AlertThresholdsSpec)
	in.DeepCopyInto(out)
	return out
}
