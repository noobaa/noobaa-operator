...
type NooBaaAccountSpec struct {
	// AllowBucketCreate is to tell if this noobaa user can create new buckets in the system
	AllowBucketCreate bool                  `json:"allow_bucket_creation"`
	
	// AllowedBuckets is to tell what buckets this noobaa user can access in the system
	AllowedBuckets    AccountAllowedBuckets `json:"allowed_buckets"`
	
	// DefaultBackingStore is to tell what backingstore this noobaa user will create new buckets on
	// +optional
