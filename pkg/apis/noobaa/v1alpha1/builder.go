...
// https://github.com/kubernetes-sigs/controller-runtime/blob/main/pkg/scheme/scheme.go
// as a part of separating the API module from the root module
...
// Package v1alpha1 contains utilities for gradually building Schemes,
