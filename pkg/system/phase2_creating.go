...
func (r *Reconciler) ReconcileDB() error {
	...
	if r.NooBaa.Spec.DBType == "postgres" || r.NooBaa.Spec.DBType == "" {
		...
		r.Logger.Errorf("UnknownDBType", "Unknown dbType is specified in NooBaa spec. DBType=%v", r.NooBaa.Spec.DBType)
