...
func (r *Reconciler) ReconcilePhaseVerifying() error {
	...
	// 	obc := &nbv1.ObjectBucket{}
	// 	obc.Name = r.NooBaaAccount.Spec.AllowedBuckets.PermissionList[i]
	// 	if !util.KubeCheck(obc) {
	// 		return util.NewPersistentError("MissingOBC",
	// 			fmt.Sprintf("NooBaa OBC %q not found or deleted", obc.Name))
	// 	}
	// }
