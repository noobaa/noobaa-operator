          ...
          properties:
              ...
              properties:
                ...
                autoscaler:
                  ...
                  properties:
                    autoscalerType:
                      description:
                        Type of autoscaling (optional) for noobaa-endpoint,
                ...
                bucketNotifications:
                  description:
                    BucketNotifications (optional) controls bucket notification
                    options
                  properties:
                    connections:
                      description: |-
                ...
                dbConf:
                  description:
                    DBConf (optional) overrides the default postgresql db
                    config
                  type: string
                dbImage:
                  description:
                    DBImage (optional) overrides the default image for the
                    db container
                  type: string
                dbResources:
                  description:
                ...
                defaultBackingStoreSpec:
                  description:
                    "Deprecated: DefaultBackingStoreSpec is not supported
                  ...
                  properties:
                      ...
                      properties:
                        ...
                        secret:
                          ...
                          properties:
                            ...
                            namespace:
                              description:
                                namespace defines the space within which
                        ...
                        sslDisabled:
                          description:
                            SSLDisabled allows to disable SSL and use plain
                            http
                          type: boolean
                        targetBucket:
                          description: TargetBucket is the name of the target S3 bucket
                    ...
                    azureBlob:
                      ...
                      properties:
                        ...
                        targetBlobContainer:
                          description:
                            TargetBlobContainer is the name of the target
                    ...
                    googleCloudStorage:
                      description:
                        GoogleCloudStorage specifies a backing store of type
                        google-cloud-storage
                      properties:
                        secret:
                          description: |-
                    ...
                    ibmCos:
                      ...
                      properties:
                        endpoint:
                          description:
                            "Endpoint is the IBM COS compatible endpoint:
                            http(s)://host:port"
                          type: string
                        secret:
                          description: |-
                        ...
                        signatureVersion:
                          description:
                            SignatureVersion specifies the client signature
                            version to use when signing requests.
                          type: string
                        targetBucket:
                          description:
                            TargetBucket is the name of the target IBM COS
                            bucket
                          type: string
                      required:
                        - endpoint
                    ...
                    pvPool:
                      ...
                      properties:
                        ...
                        resources:
                          description:
                            VolumeResources represents the minimum resources
                            each volume should have.
                          properties:
                            limits:
                              additionalProperties:
                ...
                denyHTTP:
                  description:
                    DenyHTTP (optional) if given will deny access to the
                    NooBaa S3 service using HTTP (only HTTPS)
                  type: boolean
                disableLoadBalancerService:
                  description:
                    DisableLoadBalancerService (optional) sets the service
                ...
                externalPgSSLRequired:
                  description:
                    ExternalPgSSLRequired (optional) holds an optional boolean
                    to force ssl connections to the external Postgres DB
                  type: boolean
                externalPgSSLSecret:
                  description:
                    ExternalPgSSLSecret (optional) holds an optional secret
                ...
                externalPgSSLUnauthorized:
                  description:
                    ExternalPgSSLUnauthorized (optional) holds an optional
                    boolean to allow unauthorized connections to external Postgres DB
                  type: boolean
                externalPgSecret:
                  description:
                    ExternalPgSecret (optional) holds an optional secret
                ...
                image:
                  description:
                    Image (optional) overrides the default image for the
                    server container
                  type: string
                imagePullSecret:
                  description:
                    ImagePullSecret (optional) sets a pull secret for the
                    system image
                  properties:
                    name:
                      default: ""
                ...
                loadBalancerSourceSubnets:
                  ...
                  properties:
                    s3:
                      description:
                        S3 is a list of subnets that will be allowed to access
                    ...
                    sts:
                      description:
                        STS is a list of subnets that will be allowed to
                ...
                logResources:
                  description:
                    LogResources (optional) overrides the default resource
                ...
                security:
                  ...
                  properties:
                    kms:
                      description:
                        KeyManagementServiceSpec represent various details
                        of the KMS server
                      properties:
                        connectionDetails:
                          additionalProperties:
            ...
            status:
              ...
              properties:
                ...
                actualImage:
                  description:
                    ActualImage is set to report which image the operator
                    is using
                  type: string
                beforeUpgradeDbImage:
                  description:
                    BeforeUpgradeDbImage is the db image used before last
                    db upgrade
                  type: string
                conditions:
                  description:
                  ...
                  items:
                    ...
                    properties:
                      ...
                      type:
                        description:
                          ConditionType is the state of the operator's reconciliation
                          functionality.
                        type: string
                    required:
                      - status
                ...
                lastKeyRotateTime:
                  description:
                    LastKeyRotateTime is the time system ran an encryption
                    key rotate
                  format: date-time
                  type: string
                observedGeneration:
                ...
                phase:
                  description:
                    Phase is a simple, high-level summary of where the System
                    is in its lifecycle
                  type: string
                postgresUpdatePhase:
                  description:
                    Upgrade reports the status of the ongoing postgres upgrade
                    process
                  type: string
                readme:
                  description:
                    Readme is a user readable string with explanations on
                    the system
                  type: string
                relatedObjects:
                  description: RelatedObjects is a list of objects related to this operator.
                  ...
                  properties:
                    serviceMgmt:
                      ...
                      properties:
                        externalDNS:
                          description:
                            ExternalDNS are external public addresses for
                            the service
                          items:
                            type: string
                          type: array
