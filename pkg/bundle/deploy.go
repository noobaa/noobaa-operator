...
const Sha256_deploy_crds_noobaa_io_noobaaaccounts_crd_yaml = "6c4582ae9c990399c351ad9801c55886b7e82bb34178e5289d61aa9c6c5372fd"
          ...
          spec:
            ...
            properties:
              allow_bucket_creation:
                description: AllowBucketCreate is to tell if this noobaa user can
                  create new buckets in the system
                type: boolean
              allowed_buckets:
                description: AllowedBuckets is to tell what buckets this noobaa user
                ...
                type: object
              default_resource:
                description: DefaultBackingStore is to tell what backingstore this
                  noobaa user will create new buckets on
                type: string
            required:
            - allow_bucket_creation
            - allowed_buckets
