...
const Sha256_deploy_obc_objectbucket_io_objectbucketclaims_crd_yaml = "983cac1290006119eb45068429d6f9e2bee6d187aa6488a8146d2c7d8faca445"

const File_deploy_obc_objectbucket_io_objectbucketclaims_crd_yaml = `---
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
  annotations:
      ...
      openAPIV3Schema:
        ...
        properties:
          ...
          spec:
            ...
            - message: bucketName is immutable once set
              rule: '!has(oldSelf.bucketName) || oldSelf.bucketName == "" || self.bucketName
                == oldSelf.bucketName'
            - message: generateBucketName is immutable once set
              rule: '!has(oldSelf.generateBucketName) || oldSelf.generateBucketName ==
                "" || self.generateBucketName == oldSelf.generateBucketName'
          status:
...
const Sha256_deploy_obc_objectbucket_io_objectbuckets_crd_yaml = "8ac1c0fc374b099affa8b207716e924bddb18e3c8ffcf222537d45b00c769e39"

const File_deploy_obc_objectbucket_io_objectbuckets_crd_yaml = `---
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
  annotations:
