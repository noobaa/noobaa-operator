...
const Sha256_deploy_operator_yaml = "cc4d16edf3b91add6fdd5cfd0c115eb2ca70f0d30323aab7015f3fe5294c78cf"
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: noobaa-operator
          image: noobaa/noobaa-operator:2.0.5-wip
          imagePullPolicy: IfNotPresent
          resources:
            limits:
              cpu: "250m"
