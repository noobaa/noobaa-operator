...
// KEDA release tags do not yet include controller-runtime v0.23 webhook API; track https://github.com/kedacore/keda/pull/7455
replace github.com/kedacore/keda/v2 => github.com/mycrEEpy/keda/v2 v2.0.0-20260217002815-3fd97ae4c0d5
