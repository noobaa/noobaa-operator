...
replace (
	...
	// CNPG bumps the deps in controller-runtime and k8s.io. We still need to use v0.34.2 and v0.22.5
	// Pin k8s.io dependencies to v0.34.2 and controller-runtime to v0.22.5
