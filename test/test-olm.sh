...
yq write deploy/olm-catalog/operator-source.yaml spec.registryNamespace $QUAY_NAMESPACE | kubectl apply -f -
...
kubectl apply -f deploy/olm-catalog/operator-subscription.yaml
