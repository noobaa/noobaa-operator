...
The OBC is created on the client cluster, which does not have NooBaa installed, and propagated to the provider cluster, where it is created and provisioned.  
